...
export default function StudentDashboard() {
  const navItems = [
    ...
    'STUDENT SUPPORT', 'FACILITY/IT REPORTS', 'JOBS/OPPORTUNITIES', 'FEEDBACK'
  ];
    ...
    <div className="flex h-screen bg-slate-50 text-slate-900 font-sans overflow-hidden">
      ...
      <aside className="w-64 bg-white border-r border-slate-200 flex flex-col shadow-sm z-20">
        ...
        <div className="h-16 flex items-center px-6 border-b border-slate-100">
          {/* Add your logo image file to your public folder (e.g., public/ucl-logo.png) */}
          <img 
            src="/ucl-logo.png" 
            alt="UCL Logo" 
      ...
      <div className="flex-1 flex flex-col h-screen">
        ...
        <main className="flex-1 overflow-y-auto p-8 bg-slate-50">
          ...
          {/* Welcome Banner */}
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-slate-900">Welcome back, Hesara</h1>
